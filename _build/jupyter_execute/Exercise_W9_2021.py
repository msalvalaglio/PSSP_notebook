...
<img src="./PSDs_exercise.png" alt="Drawing" style="width: 500px;">

- Compute and plot the number density, length, area, and normalised mass distribution for these two processes (an ascii file containing the measured size distributions can be downloaded from moodle.)
